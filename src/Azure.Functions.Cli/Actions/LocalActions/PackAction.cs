    ...
    internal class PackAction : BaseAction
    {
        ...
        public override ICommandLineParserResult ParseArgs(string[] args)
        {
            ...
            Parser
                ...
                .Callback(nb => ColoredConsole.WriteLine(WarningColor($"Warning: Argument {DarkCyan("--no-bundler")} is deprecated and a no-op. Python function apps are not bundled anymore.")));
            Parser
